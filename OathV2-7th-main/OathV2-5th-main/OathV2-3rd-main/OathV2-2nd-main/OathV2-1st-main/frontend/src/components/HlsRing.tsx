  ...
  return (
    <View style={{ width: size, height: size, alignItems: "center", justifyContent: "center" }}>
      <Svg width={size} height={size} style={{ transform: [{ rotate: "-90deg" }] }}>
        <Defs>
          <LinearGradient id={gradId} x1="0" y1="0" x2="1" y2="1">
            ...
            <Stop offset="100%" stopColor={t.palette.accent2} />
          </LinearGradient>
        </Defs>
        {/* Track */}
        <Circle
          cx={size / 2} cy={size / 2} r={r}
          stroke={t.palette.hairlineColor} strokeWidth={stroke} fill="none"
          strokeLinecap="round"
        />
        {/* Animated progress */}
        <AnimatedCircle
      ...
      <View style={{ position: "absolute", alignItems: "center", justifyContent: "center" }}>
        <Text style={{ color: t.palette.text, fontWeight: "800", fontSize: 28 }}>{Math.round(pct)}</Text>
