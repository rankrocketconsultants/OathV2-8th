...
export default function SettingsScreen() {
    ...
    <View style={{ flexDirection: "row", alignItems: "center", gap: t.spacing.sm, marginTop: t.spacing.xs }}>
      ...
      <Pressable
        ...
        style={{
          ...
          borderRadius: t.radii.pill, borderWidth: t.hairlineWidth, borderColor: t.palette.hairline,
  ...
  return (
    <View style={{ flex: 1, backgroundColor: "transparent" }}>
      {/* Header with LEFT action for continuity */}
      <ScreenHeader
        title="Settings"
        ...
        leftLabel="Done"
        onLeftPress={() => {
          // Prefer going back if a previous screen exists; otherwise go Home
      ...
      <ScrollView contentContainerStyle={{ padding: t.spacing.lg, gap: t.spacing.lg, paddingBottom: 160 }} showsVerticalScrollIndicator={false}>
        ...
        {/* Quiet Hours (native Switch + chevrons + inline editors) */}
        <Card>
          ...
          <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginTop: t.spacing.sm }}>
            ...
            <Switch
              ...
              trackColor={{ false: t.palette.hairline, true: t.palette.timeChipBg }}
              thumbColor={"#FFFFFF"}
            />
          </View>
        ...
        <Card>
          ...
          <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginTop: t.spacing.sm }}>
            ...
            <Switch value={settings.channelsPush} onValueChange={(v) => set({ channelsPush: v })}
          ...
          <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginTop: t.spacing.sm }}>
            ...
            <Switch value={settings.channelsSMS} onValueChange={(v) => set({ channelsSMS: v })}
              trackColor={{ false: t.palette.hairline, true: t.palette.timeChipBg }} thumbColor={"#FFFFFF"} />
          </View>
          <BankBar />
        </Card>
        ...
        <Card>
          ...
          <View style={{ alignItems: "center" }}>
            <Segmented segments={["System", "Light", "Dark"]} value={settings.theme[0].toUpperCase() + settings.theme.slice(1)} onChange={(v) => set({ theme: v.toLowerCase() as "system" | "light" | "dark" })} />
          </View>
      ...
      {/* Persistent Emerald Dock overlay on Settings */}
      <EmeraldDockOverlay />
